...
The US does not have universal health care and so citizens can either choose between private health care insurance or government funded insurance. While private health care is more expensive, it is also more flexible and so majority end up choosing this option. It is no surprise that private and public health care appears to affect both our incidence and death model. However, we do see that private health care affects our incidence and death model more since the p-values are lower than the p-value of PctPublicCoverageAlone. We believe this is because more people tend to opt for the private coverage only compared to the public coverage. The p-values for the public and private coverage in the incidence model is also slightly smaller than the ones in our death model. The difference does not seem large enough to be significant but a reason for this could be because of how these insurances cover the diagnostic portion more so than the full treatment. Although this goes against our expectations we mentioned previously in our introduction; we are not surprised because of the reasons we stated above and the fact that there are still health coverage variables we chose to leave out.
